// Package v1p8b provides the Hy-MT2 1.8B model contract.
package v1p8b
...
// New constructs the Hy-MT2 1.8B model contract.
func New() Model {
	return Model{core: hymt2.New(
		transliter.Descriptor{
			...
			Family:         "Hy-MT2",
			Parameters:     "1.8B",
			Repository:     "tencent/Hy-MT2-1.8B",
			GGUFRepository: "tencent/Hy-MT2-1.8B-GGUF",
		},
